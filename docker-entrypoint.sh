...
[[ ! -f /etc/rspamd/override.d/worker-controller-password.inc ]] && echo '# Autogenerated by openemail' > /etc/rspamd/override.d/worker-controller-password.inc
...
# These exists in openemail UI and should not be removed
